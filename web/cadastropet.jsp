...
<html lang="pt-br">
    <head>
        ...
        <title>Cadastro de Pets - Little Tooth Pets</title>
                ...
                <div class="container">
                  ...
                  <div class="collapse navbar-collapse bg-nav" id="navprincipal">
                    <ul class="navbar-nav ml-auto">
                      ...
                      <li class="nav-item">
                        <a href="cadastropet.jsp" class="nav-link mr-1 font-italic rounded-lg shadow-sm disabled" onclick="window.location.href='cadastropet.jsp'">Registrar Pet</a>
                      </li>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6 d-block d-md-block p-5">
            <section>         
                <figure class="gif">
                    <img class="img-fluid" src="img/felpudos.gif" alt="Cadastramento de Felpudos"/>
                </figure>
            </section>
          </div>
            
          <div class="col-md-6 d-flex"> <!-- cadastro pets -->
            <div class="align-self-end p-5 my-5 rounded-lg shadow-lg bgsec">            
                ...
                <hr class="">
                <form class="form-group" action="CadastroPet" method="post">                 
                    <br>
                    ...
                    <input class="form-control mb-2 shadow-sm" type="text" name="nome" placeholder="Nome/Apelido do Pet" required>
                    ...
                    <input class="form-control mb-2 shadow-sm" type="text" name="raca" placeholder="Raça do Pet" required>
                    ...
                    <input class="form-control mb-2 shadow-sm" type="text" name="porte" placeholder="Porte do Pet" required>
                    ...
                    <input class="form-control mb-2 shadow-sm" type="text" name="idade" placeholder="Idade do Pet" required>
                    ...
                    <input class="form-control mb-2 shadow-sm" type="number" step="any" name="peso" placeholder="Peso do Pet" required>
                    ...
                    <textarea class="form-control mb-3 shadow-sm" rows="3" max-row="4" name="descricao" placeholder="Deixe sua descrição." required></textarea>
